app.service('PdfMaker', [function() {
    ...
    this.createChart = function(normalDetails, child1Detail, child2Detail, child3Detail, child4Detail, child5Detail, child6Detail) {
        ...
        var rows111 = [
            { "info": "Beginning of the year of analysis", "value": normalDetails.begnYearInvestment },
            { "info": "Which state are you living in?", "value": normalDetails.spState },
            { "info": "Define your own investment return if you choose your own model?", "value": normalDetails.investmentReturn },
            { "info": "Number of Financially Dependent Children", "value": normalDetails.numChildren },
            { "info": "From which year your are going to contribute into the portfolio?", "value": normalDetails.contStartYear },
        ];
        ...
        var columns2 = [
            { title: "First Child Details", dataKey: "assets" },
        ...
        var columns3 = [
            { title: "Second Child Details", dataKey: "assets" },
            { title: "Value", dataKey: "value" },
        ];
        var rows3 = [
        ...
        var columns4 = [
            { title: "Third Child Details", dataKey: "assets" },
            { title: "Value", dataKey: "value" },
        ];
        var rows4 = [
        ...
        var columns5 = [
            { title: "Fourth Child Details", dataKey: "assets" },
            { title: "Value", dataKey: "value" },
        ];
        var rows5 = [
        ...
        var columns6 = [
            { title: "Fifth Child Details", dataKey: "assets" },
            { title: "Value", dataKey: "value" },
        ];
        var rows6 = [
        ...
        var columns7 = [
            { title: "Sixth Child Details", dataKey: "assets" },
            { title: "Value", dataKey: "value" },
        ];
        var rows7 = [
        ...
        if (normalDetails.spStateId != 5) {
            ...
            doc.autoTable(columns1, rows111, {
                margin: { top: 85 },
                styles: {
                    halign: "left",
                },
        ...
        switch (normalDetails.numChildren) {
            case 1:
            ...
            case 4:
                ...
                doc.addImage(imgData2, 'PNG', 40, 810);
                doc.setFontSize(10);
                doc.text(510, 820, 'PAGE ' + 2);
